...
Add lightweight modal-coordinate derivative and output evaluation using the verified modal representation, without adding modal simulation or aircraft-mode classification.
